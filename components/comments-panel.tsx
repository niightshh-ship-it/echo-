  ...
  return createPortal(
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="fixed inset-x-0 bottom-0 z-[61] bg-zinc-950 border-t border-white/10 rounded-t-3xl flex flex-col max-h-[78vh] animate-in slide-in-from-bottom duration-250">
        {/* Хэндл */}
